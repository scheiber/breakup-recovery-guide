          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="animate-scale-in" style={{ animationDelay: "0.1s" }}>
              <CardContent className="pt-6 flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm">Learn healthy ways to process your feelings and emotions during this difficult time.</p>
              </CardContent>
            </Card>
            ...
            <Card className="animate-scale-in" style={{ animationDelay: "0.2s" }}>
              <CardContent className="pt-6 flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm">Discover opportunities for self-improvement and personal development after a breakup.</p>
              </CardContent>
            </Card>
            ...
            <Card className="animate-scale-in" style={{ animationDelay: "0.3s" }}>
              <CardContent className="pt-6 flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm">Get actionable tips and strategies to help you navigate daily challenges.</p>
              </CardContent>
            </Card>
            ...
            <Card className="animate-scale-in" style={{ animationDelay: "0.4s" }}>
              <CardContent className="pt-6 flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm">Learn how to build a fulfilling life and healthier relationships in the future.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-8 md:py-16 bg-secondary/50">
        <div className="container max-w-4xl text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            Our carefully curated content provides a step-by-step approach to recovery, helping you transform pain into personal growth.
          </p>
          <Link to="/articles/intro">
