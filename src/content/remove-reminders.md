...
## Delete or lock all electronic records
...
Either way, after you've stored all the files some place safe where you can't access them, delete it all from your computer. Be sure to use a secure shred-and-delete program like [Eraser](https://eraser.heidi.ie/), [CCleaner](https://www.ccleaner.com/) or [FileShredder](https://www.fileshredder.org/)… otherwise, the files will still be on your computer and you'll be able to undelete them; trust me that at some low point, the temptation will be overwhelming.
